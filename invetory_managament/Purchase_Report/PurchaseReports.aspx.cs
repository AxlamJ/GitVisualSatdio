...
namespace invetory_managament.Purchase_Report
{
    public partial class PurchaseReports : System.Web.UI.Page
    {
        ...
        private void RefreshReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("PurchaseDataSet", ds.Tables[0]);
        ...
        private DataSet GetDataSet()
        {
            ...
            conn.Open();
            SqlDataAdapter ad = new SqlDataAdapter("SELECT * FROM Purchase", conn);
